...
* Your project folder should consist of 2 folders, `DOM` and `JQuery`, each containing and index.html, JS file, and any CSS files.
...
5. Add a button and an empty div. When the button is clicked, add a `span` than contains your name to the empty div.
